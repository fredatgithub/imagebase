...
namespace ImageBase.WebApp.Migrations
{
    ...
    [Migration("20201110093007_Init_11_8")]
    partial class Init_11_8
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImageBase.WebApp.Data.Models.Catalog", b =>
                {
                    ...
                    b.Property<long?>("ParentCatalogId")
            ...
            modelBuilder.Entity("ImageBase.WebApp.Data.Models.ImageKeyWord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("images_key_words");
                });

            modelBuilder.Entity("ImageBase.WebApp.Data.Models.KeyWord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("ImageBase.WebApp.Data.Models.ImageKeyWord", b =>
                {
                    b.HasOne("ImageBase.WebApp.Data.Models.Image", "Image")
                        .WithMany("ImageKeyWords")
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ImageBase.WebApp.Data.Models.KeyWord", "KeyWord")
                        .WithMany("ImageKeyWords")
